...
1. `taskledger --root /workspace handoff implementation-context rewrite-v2 --format markdown`
...
5. `taskledger --root /workspace implement add-change rewrite-v2 --path taskledger/storage/v2.py --kind edit --summary "Normalized v2 markdown storage."`
